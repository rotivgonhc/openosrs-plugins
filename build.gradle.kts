...
allprojects {
	group = "com.rotivgonhc"
	version = ProjectVersions.openosrsVersion
	apply<MavenPublishPlugin>()
}

project.extra["GithubUrl"] = "https://github.com/rotivgonhc/openosrs-plugins"
	...
	repositories {
		...
		exclusiveContent {
			...
			filter {
				...
				includeModule("net.runelite.gluegen", "gluegen-rt-natives-macosx")
				includeModule("net.runelite", "discord")
				includeModule("net.runelite.jogl", "jogl-all")
				includeModule("net.runelite.jogl", "jogl-all-natives-macosx")
