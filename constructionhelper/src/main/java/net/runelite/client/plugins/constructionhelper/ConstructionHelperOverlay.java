...
public class ConstructionHelperOverlay extends Overlay
{
	...
	public ConstructionHelperOverlay(ConstructionHelperPlugin plugin)
	{
		...
		this.getMenuEntries().add(new OverlayMenuEntry(MenuAction.RUNELITE_OVERLAY_CONFIG, "Configure", "Construction Helper Overlay"));
	}
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		else
		{
			...
			tableComponent.addRow(new String[] {"Construction Helper"});
